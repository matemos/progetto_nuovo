...
public class SommaVettore extends Application {

	TextField tNum = new TextField();
	TextField tNMax = new TextField();
	
	ComboBox<String> cOperazioni = new ComboBox<String>();
	...
	private void calcola() {
		String val = cOperazioni.getValue().toString();
